...
class snscontrollers extends Controller
{
    ...
    public function detail($id) {
        ...
        $messages = Message::find($id)->userTable;
        $users = User::find($id)->commentUser;
        $comments = Comment::find($id)->commentDate;
        // dd($comments);
        return view('detail', compact('userDate', 'users', 'comments'));
    }
