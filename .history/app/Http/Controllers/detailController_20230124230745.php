...
class detailController extends Controller
{
    ...
    public function show($id)
    {
        ...
        // コメントのユーザー情報
        $commentuser = $messages->comment_message;

        // foreach($commentuser as $co)
        // {
        //     dd($co->comment_users->name);
        // }
        // 二つを配列へ
        $arrayuser = [
            $comment_message => [$commentuser]
        ];
        ...
        return view('detail', compact('messages', 'users', 'comment_message', 'commentuser', 'arrayuser', 'post', 'like'));
    }
