...
class messageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $params = [
            ...
            'postimg1' => ['nullable','image','mimes:jpg,jpeg,png'],
            'postimg2' => ['nullable','image','mimes:jpg,jpeg,png']
        ];
        ...
        { //入っていれば名前をつけ保存
            $postimgname1 = $request->postimg1->getClientOriginalName();
            $imgnewname1 = date('Ymd_His'.'_'.$postimgname1);
            $postImgDate1 = $request->postimg1->storeAs('public/img', $imgnewname1);
        ...
        { //入っていれば名前をつけ保存
            ...
            $postImgDate2 = $request->file('postimg2')->storeAs('public/img', $imgnewname2);
            $postImg2 = 'storage/img/' . $imgnewname2;
        } else {
            // $postImg2 = null;
