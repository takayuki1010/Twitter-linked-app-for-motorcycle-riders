...
class userTest extends TestCase
{
    ...
    public function test_listview(){
        ...
        $response = $this->actingAs($this->user)->get(route('list.index'));
    ...
    public function test_userlist()
    {
        ...
        $response = $this->actingAs($this->user->role(5))->get('/admin');
    ...
    public function test_logoutview()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('logout.index'));
    ...
    public function test_userChange()
    {
        ...
        $response = $this->actingAs($this->user)->get('change/{$user->id}/edit');
    ...
    public function test_userChangecomp()
    {
        ...
        $response = $this->actingAs($this->user)->PATCH('change/{$user->id}');
    ...
    public function test_delete()
    {
        ...
        $response = $this->actingAs($this->user)->get(route('delete.index'));
    ...
    public function test_deletecomp()
    {
        ...
        $response = $this->actingAs($this->user)->DELETE('delete/{$user->id}');
   ...
   // 認証ユーザーにして、作成ページに行ける事
    ...
    $response = $this->POST(route('message.store'), $message);
