...
class userTest extends TestCase
{
    ...
    public function test_password_reset3()
    {
        $response = $this->post(route('password_reset.email.send_complete'));

        $response->assertViewIs('resetend');

        $response->assertSeeText('メール送信しました。');
