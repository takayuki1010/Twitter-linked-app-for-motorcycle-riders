...
<section>
    <div class="register">
        <!-- regicompへ保存して遷移 -->
        <form action="{{ route('regicomp.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="register-menu">
                ...
                <!-- バリデーションエラーで表示 -->
                    ...
                    <span style="color:red; font-size: 12px;">パスワードが不正です。半角英数字と-と_のみで6文字以上12文字以内で入力してください。</span>
                    @endif
