...
<section>
    ...
    <div class="detail-main">
        ...
        <div class="detail-createds">
            ...
            @if($like)
            <!-- 「いいね」取消用ボタンを表示 -->
                <a style="text-decoration:none;  color: white;" href="/reply/unlike/{{ $messages->id }}" class="btn btn-success btn-sm">
            ...
            <!-- まだユーザーが「いいね」をしていなければ、「いいね」ボタンを表示 -->
                <a style="text-decoration:none; color: white;" href="/reply/like/{{ $messages->id }}" class="btn btn-secondary btn-sm">
