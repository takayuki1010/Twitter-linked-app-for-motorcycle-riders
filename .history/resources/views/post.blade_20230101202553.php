    ...
    <div class="posts">
        ...
        @csrf
            ...
            <div class="posts-img">
                ...
                <div class="ImgPost">
                    <p>写真１</p><input type="file" value="{{ old('postimg1') }}" accept="image/jpeg, image/png" name="postimg1">
                </div>
                <div class="ImgPost">
                <p>写真２</p><input type="file" value="{{ old('postimg2') }}" accept="image/jpeg, image/png" name="postimg2">
                </div>
            </div>
        </form>
    </div>
