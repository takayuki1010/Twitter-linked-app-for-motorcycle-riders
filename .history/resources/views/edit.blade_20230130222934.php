        ...
        <div class="edit">
            ...
            <form method="POST" action="{{ route('password_reset.update') }}">
                ...
                <div class="input-group">
                    ...
                    @error('password')
                        <div class="error" style="color:red; font-size:12px;">パスワードが不正です。半角英数字と-と_のみで6文字以上12文字以内で入力してください。</div>
                    @enderror

                    @error('token')
                        <div class="error" style="color:red; font-size:12px;">上記と同じものを入力してください。</div>
                    @enderror
