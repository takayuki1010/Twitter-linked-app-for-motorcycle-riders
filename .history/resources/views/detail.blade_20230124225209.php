...
<section>
    ...
    <div class="detail-main">
        ...
        <div class="detail-createds">
            ...
            @if($like)
            <!-- 「いいね」取消用ボタンを表示 -->
                <a style="text-decoration:none;" href="/reply/unlike/{{ $messages->id }}" class="btn btn-success btn-sm">
            ...
            <!-- まだユーザーが「いいね」をしていなければ、「いいね」ボタンを表示 -->
                <a style="text-decoration:none;" href="/reply/like/{{ $messages->id }}" class="btn btn-secondary btn-sm">
    ...
    @foreach(array_combine($comment_message, $commentuser) as $comments => $commentusers)
        <div class="detail-comment">
            <div class="user-icom">
            <!-- コメントしている人のアイコン -->
                <img src="{{ asset($commentusers->comment_users->img) }}" alt="">
