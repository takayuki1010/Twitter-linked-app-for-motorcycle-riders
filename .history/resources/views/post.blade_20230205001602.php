...
<section>
    ...
    <div class="posts">
        <form action="{{ route('message.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <!-- 投稿内容 -->
            <div class="post-text">
                <textarea name="PostText" id="" cols="30" rows="10" placeholder="ニックネームなどの情報を入力してください">
                    {{ old('PostText') }}
                </textarea>
            </div>
            ...
            <div class="posts-img">
                ...
                @if($errors->has('postimg1') || $errors->has('postimg2'))
                    <span style="color:red; font-size: 12px;">投稿した画像が不正です。2MBまでのjpeg、もしくはpngを投稿してください。</span>
                @endif
